...
*/
#define SUPERFRAME_LENGTH    23 //should be 101             changed by erfan from 11 to 21 !! noticeable that number must be odd !!
...
#define NUMSLOTSOFF          8  // changed from 1 to 18 by erfan !! Used to set dedicated cells
