...
\Import static scheduling which is defined
 ...
 By default MOTE 1 is set as Sink
...
void schedule_addYourSchedule(){
    ...
    if(myaddr64b->addr_64b[7] == 0x02){
        ...
        schedule_addActiveSlot(8, CELLTYPE_TX, FALSE, 1, &neighborAddress);       
	schedule_addActiveSlot(10, CELLTYPE_TX, FALSE, 1, &neighborAddress);
	schedule_addActiveSlot(16, CELLTYPE_TX, FALSE, 1, &neighborAddress);
        ...
        // (4->8)
        neighborAddress.addr_64b[7]      = 0x08;
        schedule_addActiveSlot(5, CELLTYPE_TX, FALSE, 2, &neighborAddress); 
    	...
    	// (5->1)
    	neighborAddress.addr_64b[7]      = 0x01;
	schedule_addActiveSlot(4, CELLTYPE_TX, FALSE, 0, &neighborAddress);       
	schedule_addActiveSlot(6, CELLTYPE_TX, FALSE, 0, &neighborAddress);
	schedule_addActiveSlot(12, CELLTYPE_TX, FALSE, 0, &neighborAddress);
	schedule_addActiveSlot(14, CELLTYPE_TX, FALSE, 1, &neighborAddress);             

        // (10->5)
        neighborAddress.addr_64b[7]      = 0x0a;
        schedule_addActiveSlot(3, CELLTYPE_RX, FALSE, 1, &neighborAddress);
        schedule_addActiveSlot(5, CELLTYPE_RX, FALSE, 1, &neighborAddress);
        schedule_addActiveSlot(7, CELLTYPE_RX, FALSE, 1, &neighborAddress);
        ...
        schedule_addActiveSlot(4, CELLTYPE_TX, FALSE, 1, &neighborAddress);
	schedule_addActiveSlot(6, CELLTYPE_TX, FALSE, 1, &neighborAddress);
	schedule_addActiveSlot(12, CELLTYPE_TX, FALSE, 1, &neighborAddress);
	...
	// (4->8)
        ...
        schedule_addActiveSlot(5, CELLTYPE_RX, FALSE, 2, &neighborAddress); 
        ...
        // (9->13)
        neighborAddress.addr_64b[7]      = 0x0d;
        schedule_addActiveSlot(14, CELLTYPE_TX, FALSE, 0, &neighborAddress);
        ...
        schedule_addActiveSlot(5, CELLTYPE_TX, FALSE, 1, &neighborAddress);     
        schedule_addActiveSlot(7, CELLTYPE_TX, FALSE, 1, &neighborAddress);     
        ...
        // (15->10)
        neighborAddress.addr_64b[7]      = 0x0f;
        ...
        // (11->13)
        neighborAddress.addr_64b[7]      = 0x0d;
        schedule_addActiveSlot(16, CELLTYPE_TX, FALSE, 0, &neighborAddress);     
        ...
        // (13->1)
        neighborAddress.addr_64b[7]      = 0x01;
        schedule_addActiveSlot(3, CELLTYPE_TX, FALSE, 0, &neighborAddress);
        schedule_addActiveSlot(5, CELLTYPE_TX, FALSE, 0, &neighborAddress);
        schedule_addActiveSlot(7, CELLTYPE_TX, FALSE, 0, &neighborAddress);
        schedule_addActiveSlot(9, CELLTYPE_TX, FALSE, 0, &neighborAddress);
        schedule_addActiveSlot(11, CELLTYPE_TX, FALSE, 0, &neighborAddress);
        schedule_addActiveSlot(13, CELLTYPE_TX, FALSE, 0, &neighborAddress);
        schedule_addActiveSlot(15, CELLTYPE_TX, FALSE, 0, &neighborAddress);
        schedule_addActiveSlot(17, CELLTYPE_TX, FALSE, 0, &neighborAddress);

        // (8->13)
        neighborAddress.addr_64b[7]      = 0x08;
        schedule_addActiveSlot(4, CELLTYPE_RX, FALSE, 1, &neighborAddress);
	schedule_addActiveSlot(6, CELLTYPE_RX, FALSE, 1, &neighborAddress);
	schedule_addActiveSlot(12, CELLTYPE_RX, FALSE, 1, &neighborAddress);

        // (9->13)
        neighborAddress.addr_64b[7]      = 0x09;
        schedule_addActiveSlot(14, CELLTYPE_RX, FALSE, 0, &neighborAddress);

        // (11->13)
        neighborAddress.addr_64b[7]      = 0x0b;
        schedule_addActiveSlot(16, CELLTYPE_RX, FALSE, 0, &neighborAddress);

        // (16->13)
        neighborAddress.addr_64b[7]      = 0x10;
        schedule_addActiveSlot(8, CELLTYPE_RX, FALSE, 0, &neighborAddress);
	schedule_addActiveSlot(10, CELLTYPE_RX, FALSE, 0, &neighborAddress);
        ...
        // (16->13)
        neighborAddress.addr_64b[7]      = 0x0d;
        schedule_addActiveSlot(8, CELLTYPE_TX, FALSE, 0, &neighborAddress);
	schedule_addActiveSlot(10, CELLTYPE_TX, FALSE, 0, &neighborAddress);
...
void schedule_startDAGroot() {
   ...
   if (defaultSchedule) {
	   ...
	   for (running_slotOffset=start_slotOffset;running_slotOffset<start_slotOffset+SCHEDULE_MINIMAL_6TISCH_ACTIVE_CELLS;running_slotOffset++) {
		...
		// (2->1)
		neighborAddress.addr_64b[7]      = 0x02;
		schedule_addActiveSlot(8, CELLTYPE_RX, FALSE, 1, &neighborAddress);       
		schedule_addActiveSlot(10, CELLTYPE_RX, FALSE, 1, &neighborAddress);
		schedule_addActiveSlot(16, CELLTYPE_RX, FALSE, 1, &neighborAddress);             

	        // (5->1)
		neighborAddress.addr_64b[7]      = 0x05;
		schedule_addActiveSlot(4, CELLTYPE_RX, FALSE, 0, &neighborAddress);       
		schedule_addActiveSlot(6, CELLTYPE_RX, FALSE, 0, &neighborAddress);
		schedule_addActiveSlot(12, CELLTYPE_RX, FALSE, 0, &neighborAddress); 
    		schedule_addActiveSlot(14, CELLTYPE_RX, FALSE, 1, &neighborAddress);           

		// (13->1)
		neighborAddress.addr_64b[7]      = 0x0d;
		schedule_addActiveSlot(3, CELLTYPE_RX, FALSE, 0, &neighborAddress);           
		schedule_addActiveSlot(5, CELLTYPE_RX, FALSE, 0, &neighborAddress);           
		schedule_addActiveSlot(7, CELLTYPE_RX, FALSE, 0, &neighborAddress);           
		schedule_addActiveSlot(9, CELLTYPE_RX, FALSE, 0, &neighborAddress);           
		schedule_addActiveSlot(11, CELLTYPE_RX, FALSE, 0, &neighborAddress);  
		schedule_addActiveSlot(13, CELLTYPE_RX, FALSE, 0, &neighborAddress);           
		schedule_addActiveSlot(15, CELLTYPE_RX, FALSE, 0, &neighborAddress);           
		schedule_addActiveSlot(17, CELLTYPE_RX, FALSE, 0, &neighborAddress);           
