...
class Propagation(eventBusClient.eventBusClient):
    ...
    def createConnection(self,fromMote,toMote, pdrtimes = -1):  # pdrtimes added by erfan !!!
        ...
        with self.dataLock:
            ...
            if not self.simTopology:
                ...
                if pdrtimes == -1:   # pdrtimes added by erfan !!!
                    Prx             -= PISTER_HACK_LOSS*random.random()
                else:
                    Prx             -= PISTER_HACK_LOSS*pdrtimes  # pdrtimes added by erfan !!!
