...
class moteState(eventBusClient.eventBusClient):
    ...
    def __init__(self,moteConnector):
        ...
        # added by erfan to log Duty Cycle
        #print('hi\n')
        #DUTY_CYCLE = StateMacStats.dutyCycle
        #MOTE_ID    = self.ST_IDMANAGER.StateIdManager.
        #DutyCycle_file = open('_Log_DutyCycle.txt','a')
        #DutyCycle_file.write(self.ST_IDMANAGER.StateIdManager.)
	#DutyCycle_file.write(' ')
        #DutyCycle_file.write(time.strftime("%H %M %S %"))
	#DutyCycle_file.write(' ')
        #DutyCycle_file.write(str(DUTY_CYCLE))
	#DutyCycle_file.write('\n')
        #DutyCycle_file.close()
        # end of erfan
