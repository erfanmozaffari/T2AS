...
enum {
   ...
   WKP_UDP_CONVERGECAST                = 10000,  // added by erfan to add new application!!
};
...
enum {
   ...
   COMPONENT_RRT                       = 0x25,
   COMPONENT_UDPCONVERGECAST           = 0X30,    // added by erfan to add new app!!
};
...
// added by erfan to get packet ID
uint16_t DataPacketID[15];
// end of erfan
