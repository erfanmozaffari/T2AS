...
*/
#define SUPERFRAME_LENGTH    23 //should be 101             changed by erfan from 11 to 23 !! noticeable that number must be odd !!

//draft-ietf-6tisch-minimal-06
#define SCHEDULE_MINIMAL_6TISCH_ACTIVE_CELLS                      3  // This parameter determines number of TXRX cells by erfan
...
#define NUMSLOTSOFF         16  // changed from 1 to 10 by erfan !! Used to set dedicated cells
...
//===== Import my own scheduling  erfan !!
